...
// comment by zoomin: not very clear about this file, so the change may not be right

define(
['config', 'bigl', 'stapes', 'sosomaps', 'sv_svc', 'jquery'],
function(config, L, Stapes, QMaps, sv_svc, $) {
  ...
  var EarthPosModule = Stapes.subclass({
    constructor: function(map) {
      ...
      QMaps.event.addListenerOnce(this.map, 'idle', function(event) {
